...
export async function PATCH(request) {
    try {
        ...
        if (isFeatured && days) {
            ...
            featuredUntil.setDate(featuredUntil.getDate() + 7); // Default 7 days
        }
        ...
        return NextResponse.json({ message: `Property ${isFeatured ? 'featured' : 'unfeatured'} successfully`, property: updated });
    } catch (error) {
